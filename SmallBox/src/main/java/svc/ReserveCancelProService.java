...
public class ReserveCancelProService {
	...
	// 예매내역 결제 중 취소건에 대해 예매내역 삭제
	public boolean cancelReserve2(int res_num) {
		boolean isCancelSuccess = false;
		...
		// BoardDAO 의 cancelReserve2() 메서드를 호출하여 글 삭제 작업 수행
		int cancelCount = dao.cancelReserve2(res_num);

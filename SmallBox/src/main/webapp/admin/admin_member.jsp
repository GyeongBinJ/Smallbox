						...
						<tbody>
							...
							<c:forEach var="member" items="${memberList }">
								...
								<tr>
									...
									<td colspan="1">
										<!-- 멤버 아이디와 일치하는 회원에게 쿠폰 지급 및 목록 수행 --> <input type="button"
										class="pagebtn" value="쿠폰 지급"
										style="border-radius: 4px; margin-top: 5px;"
										onclick="location.href='CouponInsert.ad?member_id=${member.member_id }'">
										<input type="button" class="pagebtn" value="쿠폰 목록"
										style="border-radius: 4px; margin-top: 5px;"
								...
								<td colspan="8">
									...
									<form action="MemberList.ad">
										<input type="text" class="pagebtn" name="keyword"
											style="border-radius: 4px; margin-top: 5px;"> <input
											type="submit" class="pagebtn" value="검색"
											style="border-radius: 4px; margin-top: 5px;">
									</form> <!-- 
